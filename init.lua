-- IMPORT CONTENTS OF OLD INIT.VIM FILE --
...
vim.cmd([[
  ...
  nnoremap <C-[><C-[> :noh<Enter>
  nnoremap <C-\> :1 mes<Enter>
  nnoremap - :NERDTreeToggle<Enter>
  nnoremap [r :Rest run<Enter>
  ...
  """ Prevent conflict between nvim-autopairs and CoC
  ""inoremap <silent><expr> <CR> coc#pum#visible() ? coc#pum#confirm() :
...
require('obsidian').setup({
  workspaces = {
    {
      name = 'Capstone',
      path = '~/Documents/Obsidian/Capstone',
    },
  }
})
